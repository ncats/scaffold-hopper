// $Id: TautomerGenerator.java 4029 2010-02-01 21:33:07Z nguyenda $
 ...
 */
public class TautomerGenerator {
	...
	(TautomerGenerator.class.getName());
    ...
    public TautomerGenerator () {
	this (MAX_SIZE);
    }

    public TautomerGenerator (int maxsize) {
	setMaxCount (maxsize);
    }

    public TautomerGenerator (int maxsize, int mask) {
	setMaxCount (maxsize);
	set (mask);
    }
    ...
    @Override
    public Object clone () {
	TautomerGenerator taugen = new TautomerGenerator();
    ...
    public int getMaxCount () { return maxsize; }
    public void setMaxCount (int maxsize) { this.maxsize = maxsize; }
	...
	*/
    ...
    public Enumeration<Molecule> getTautomers () {
	...
	return MolStandardizer.canonicalSMILES(getCanonicalTautomer());
    }
	...
	if (debug) {
	    ...
	    System.out.println(smiles + "\t" + MolStandardizer.hash51(smiles));
	}
	...
	*/
	...
	taugen.setMolecule(mol.cloneMolecule());
	taugen.run();
